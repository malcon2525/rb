  ...
  <div class="card ">
    ...
    <div id="collapse<?=$a?>One" class="collapse show" role="tabpanel" aria-labelledby="heading<?=$a?>One" data-parent="#accordion">
      ...
      <div class="card-body">
        ...
        <div class="row"> 
          <div class="col-md-6">
            <a href="index.php?pag=conteudo-cad&menu_id=<?=$menu_id?>" class="btn btn-primary">Inserir Conteúdo</a><br><br>
          </div>
          <div class="col-md-6">
            <?
              $menu_id = ( isset($_GET['menu_id']) ? $_GET['menu_id'] : '');
            ...
            <?
              ...
              if ($conteudoDB) {
                foreach ($conteudoDB as $conteudo) {
                  $linkEditar = "index.php?pag=conteudo-cad&alterar=$conteudo[id]&menu_id=$conteudo[menu_id]";
